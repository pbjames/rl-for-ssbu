...
class ControllerAgent:
    ...
    def goto_battlefield(self):
        ...
        self.gamepad.update()
        time.sleep(0.5)
        self.gamepad.press_button(XUSB_BUTTON.XUSB_GAMEPAD_Y)
        self.gamepad.update()
        time.sleep(0.5)
        self.gamepad.release_button(XUSB_BUTTON.XUSB_GAMEPAD_Y)
        self.gamepad.update()
        time.sleep(0.5)
        self.gamepad.press_button(XUSB_BUTTON.XUSB_GAMEPAD_B)
        self.gamepad.update()
    ...
    def set_cpu_marth(self):
        ...
        self.gamepad.update()
        time.sleep(3)
        self.gamepad.left_joystick(32767, 16384)
        self.gamepad.update()
        time.sleep(1.25)
        self.gamepad.left_joystick(0, 0)
        self.gamepad.update()
    ...
    def simulate_classroom_with_cpu(self):
        ...
        self.gamepad.release_button(XUSB_BUTTON.XUSB_GAMEPAD_B)
        self.gamepad.update()
        self.gamepad.press_button(XUSB_BUTTON.XUSB_GAMEPAD_START)
        self.gamepad.update()
        time.sleep(0.5)
        self.gamepad.release_button(XUSB_BUTTON.XUSB_GAMEPAD_START)
        self.gamepad.update()


def main():
    c = ControllerAgent()
    c.simulate_classroom_with_cpu()
