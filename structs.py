...
class Status(StrEnum):
    ...
    CliffRobbed = "CliffRobbed"
    CliffCatchMove = "CliffCatchMove"
    EscapeAir = "EscapeAir"
    Escape = "Escape"
    EscapeB = "EscapeB"
    EscapeF = "EscapeF"
    ...
    DamageFly = "DamageFly"
    DamageAir = "DamageAir"
    DamageFlyRoll = "DamageFlyRoll"
    Wait = "Wait"
    Landing = "Landing"
    LandingLight = "LandingLight"
    LandingAttackAir = "LandingAttackAir"
    LandingDamageLight = "LandingDamageLight"
    LandingFallSpecial = "LandingFallSpecial"
    JumpSquat = "JumpSquat"
    JumpAerial = "JumpAerial"
    Pass = "Pass"
    WalkBrake = "WalkBrake"
    RunBrake = "RunBrake"
    Turn = "Turn"
